function WhiteQueen() {
  return (
    <svg viewBox="0 0 45 45" style={{ width: '100%', height: '100%' }}>
      <g style={{ fill: '#ffffff', fillOpacity: 1, fillRule: 'evenodd', stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
...
function BlackRook() {
  return (
    <svg viewBox="0 0 45 45" style={{ width: '100%', height: '100%' }}>
      <g style={{ fill: '#000000', fillOpacity: 1, fillRule: 'evenodd', stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
...
export default function Piece({ type, color }) {
  const Component = PIECE_COMPONENTS[type]?.[color];
  if (!Component) return null;
  return (
    <div style={{ width: '82%', height: '82%', pointerEvents: 'none', userSelect: 'none' }}>
      <Component />
    </div>
  );
}
